...
{
	QString text = QString("ESPixelStick Flasher v%1<br>QT v%2<br><br>Icons by:")
		.arg(PROJECT_VER, QT_VERSION_STR) +
		QStringLiteral("<br><a href='http://www.famfamfam.com/lab/icons/silk/'>www.famfamfam.com</a>");
		//http://www.famfamfam.com/lab/icons/silk/
	QMessageBox::about( this, "About ESPixelStick Flasher", text );
}
...
void MainWindow::on_pbFlash_clicked()
{
